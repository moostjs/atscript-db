...
| SQLite specifics     | [adapters-sqlite.md](references/adapters-sqlite.md)     | `BetterSqlite3Driver`, FTS5, `@db.column.collate`, native FKs, in-memory `:memory:`, `$regex` → `LIKE … ESCAPE '\'` (restricted subset, throws on `\d`/`[…]`/`(a\|b)`/quantifiers)                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
